...
* Support PyTorch *_like factory operations in AnalogContext placeholder mode without reading backing weight values, with CPU and CUDA regression coverage [(\#785)](https://github.com/IBM/aihwkit/pull/785)
