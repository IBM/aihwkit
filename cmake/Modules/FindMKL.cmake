...
IF ("$ENV{INTEL_HOME}" STREQUAL "" )
  SET(INTEL_HOME_DIR "/opt/intel" CACHE STRING "INTEL HOME")
ELSE()
  SET(INTEL_HOME_DIR "$ENV{INTEL_HOME}" CACHE STRING "INTEL HOME")
ENDIF()


SET(INTEL_COMPILER_DIR "${INTEL_HOME_DIR}" CACHE STRING
  "Root directory of the Intel Compiler Suite (contains ipp, mkl, etc.)")
SET(INTEL_MKL_DIR "${INTEL_HOME_DIR}/mkl" CACHE STRING
