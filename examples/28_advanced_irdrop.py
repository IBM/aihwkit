...
def network_comparison(
    ...
    plot_model_names_dict = {
        "default_conventional_model_dt_irdrop": r"Conventional \ Mode \ Advanced \ IR \ Drop \ Default",
        "conventional_model_dt_irdrop_PCMnoise": r"Conventional \ Mode \ Advanced \ IR \ Drop \ PCM \ Noise",
        "conventional_model_dt_irdrop_noADC": r"Conventional \ Mode \ Advanced \ IR \ Drop \ noADC",
...
if __name__ == "__main__":
    ...
    rpu_config_default_conventional_dt_irdrop = rpu_config_modifications(TorchInferenceRPUConfigIRDropT())
    ...
    model_dict.update({"default_conventional_model_dt_irdrop": model_default_conventional_dt_irdrop})

    # conventional time-dependent ir drop with input-dependent PCM read noise (for addition flag testing)
    rpu_config_conventional_dt_irdrop_PCMnoise = rpu_config_modifications(TorchInferenceRPUConfigIRDropT())
    ...
    # conventional time-dependent ir drop without ADC quantization (for addition flag testing)
    rpu_config_conventional_dt_irdrop_noADC = rpu_config_modifications(TorchInferenceRPUConfigIRDropT())
