...
from transformer_utils import logger

CONFIG_NAME = "config.json"
ENV_VARS_TRUE_VALUES = {"1", "ON", "YES", "TRUE"}

_staging_mode = os.environ.get("HUGGINGFACE_CO_STAGING", "NO").upper() in ENV_VARS_TRUE_VALUES
_default_endpoint = ("https://moon-staging.huggingface.co"
                        if _staging_mode else "https://huggingface.co")

HUGGINGFACE_CO_RESOLVE_ENDPOINT = _default_endpoint
if os.environ.get("HUGGINGFACE_CO_RESOLVE_ENDPOINT", None) is not None:
    warnings.warn(
        "Using the environment variable `HUGGINGFACE_CO_RESOLVE_ENDPOINT`"
        "Use `HF_ENDPOINT` instead.",
        FutureWarning,
    )
    HUGGINGFACE_CO_RESOLVE_ENDPOINT = os.environ.get("HUGGINGFACE_CO_RESOLVE_ENDPOINT", None)

HUGGINGFACE_CO_RESOLVE_ENDPOINT = os.environ.get("HF_ENDPOINT", HUGGINGFACE_CO_RESOLVE_ENDPOINT)
HUGGINGFACE_CO_PREFIX = (HUGGINGFACE_CO_RESOLVE_ENDPOINT +
...
def is_offline_mode():
    return os.environ.get("TRANSFORMERS_OFFLINE", "0").upper() in ENV_VARS_TRUE_VALUES
...
def cached_path(
    ...
    if is_remote_url(url_or_filename):
        # TODO: Get the downloading working
        ...
        # )
        logger.error("Downloading URLs not currently supported. Pass in local path instead")
...
class PretrainedConfig:
    ...
    def _get_config_dict(
        ...
        # TODO: Add these classes (they're just wrappers of HTTPError)
