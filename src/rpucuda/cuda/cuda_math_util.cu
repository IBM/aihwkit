...
RPU_CMU_DEFINE_CWI(chop_t *, chop_t *);
...
RPU_CMU_DEFINE_CWI(float *, DiagInputIterator<float COMMA float>);
RPU_CMU_DEFINE_CWI(float *, EyeInputIterator<float>);
RPU_CMU_DEFINE_CWI(float *, IndicatorInputIterator<float>);
RPU_CMU_DEFINE_CWI(float *, LogInputIterator<float>);
RPU_CMU_DEFINE_CWI(float *, NegateInputIterator<float>);
...
RPU_CMU_DEFINE_CWI(double *, DiagInputIterator<double COMMA double>);
RPU_CMU_DEFINE_CWI(double *, EyeInputIterator<double>);
RPU_CMU_DEFINE_CWI(double *, IndicatorInputIterator<double>);
RPU_CMU_DEFINE_CWI(double *, LogInputIterator<double>);
RPU_CMU_DEFINE_CWI(double *, NegateInputIterator<double>);
...
RPU_CMU_DEFINE_CWI(half_t *, DiagInputIterator<half_t COMMA half_t>);
RPU_CMU_DEFINE_CWI(half_t *, EyeInputIterator<half_t>);
RPU_CMU_DEFINE_CWI(half_t *, IndicatorInputIterator<half_t>);
RPU_CMU_DEFINE_CWI(half_t *, LogInputIterator<half_t>);
RPU_CMU_DEFINE_CWI(half_t *, NegateInputIterator<half_t>);
