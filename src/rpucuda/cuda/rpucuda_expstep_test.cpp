...
template <typename Tio> class RPUCudaExpstepStateTestFixture : public ::testing::Test {
public:
  void SetUp() {
    ...
    ExpStepRPUDeviceMetaParameter<num_t> dp;
...
TYPED_TEST_CASE(RPUCudaExpstepStateTestFixture, Tios);
...
TYPED_TEST(RPUCudaExpstepStateTestFixture, UpdateVector) {
...
TYPED_TEST(RPUCudaExpstepStateTestFixture, UpdateMatrixBatch) {
